...
import {ChevronBack, ChevronFoward, Location, People, Percent, Plus,} from "../../public/svgIcons";
          ...
          <div>
              ...
              <div className={"flex justify-between"}>
                  <div className={"flex items-end"}>
                      <p className={" border-x-4 border-my_yellow px-2 py-0  font-normal text-md sm:text-lg md:text-xl"}>Food
                          <span className={" font-medium text-lg capitalize sm:text-xl md:text-2xl"}> Items</span>
                      </p>
